...
def random_zola(m1):
    ...
    size=1
    h2b = 15+r(15)
    b2la = [25+r(20),-10+r(35)]
    la2lh = [15+r(15),-20+r(40)]
    b2ra = [25+r(20),-10+r(35)]
    ra2rh = [15+r(15),-20+r(40)]
    b2b = 30+r(10)
    b2ln = [20+r(20),20+r(20)]
    ln2lf = [-20+r(20),20+r(10)]
    b2rn = [20+r(20),20+r(20)]
    rn2rf = [-20+r(20),20+r(10)]
...
if __name__ == "__main__":
    ...
    for i in range(2):
        for j in range(3):
            wait_cnc = 1
            wait_cnc = move_cnc(600*j,1200*i-600)
            while wait_cnc:
                sleep(0.1)
            sleep(1)
            # 로봇팔 움직임
